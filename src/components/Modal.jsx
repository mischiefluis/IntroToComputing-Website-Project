...
const Modal = ( {display, opac} ) => {
  let displayClass = display

  return (
    <div className={`bg-black/80 w-full h-screen fixed z-50 flex items-center justify-center transition-all ease-in-out duration-700 ${display} ${opac}`}>
