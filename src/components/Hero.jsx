  ...
  return (
    <div className='absolute top-10 w-full h-full px-4 flex flex-col xl:flex-row items-center justify-evenly xl:gap-0 xl:justify-between'>
      <div className='xl:w-[48%] text-center xl:text-left'>
        ...
        <p className='parag text-white leading-[1.25] mb-5 hidden xl:block'>Follow the roadmaps for what you should work on more to enhance your mathematics skills, and watch videos that will help you along the way solving calculus.</p>
