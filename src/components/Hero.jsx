  ...
  return (
    <div className='absolute top-10 w-full h-full px-4 flex flex-col xl:flex-row items-center justify-evenly xl:gap-0 xl:justify-between'>
      <div className='xl:w-[48%] text-center xl:text-left'>
        <h1 className='heading-1 uppercase font-bold text-white leading-[1] mb-4 xl:mb-3'>Struggling with <span className='text-acc'>Calculus</span>?</h1>
        ...
        <Link to="/videos/limits" className='button heading-3 text-white font-bold uppercase transition-all ease-in-out'>Click Here</Link>
      </div>
